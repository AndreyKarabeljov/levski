var wpDataTablesHighchart = function() {
    var obj = {
        ...
        setMultiplyYaxis: function(chartConfig) {
            if (chartConfig.type == 'highcharts_spline_chart' || chartConfig.type == 'highcharts_line_chart' || chartConfig.type == 'highcharts_basic_column_chart' || chartConfig.type == 'highcharts_basic_area_chart' || chartConfig.type == 'highcharts_basic_bar_chart') {
                var j = 0;
        ...
        setChartConfig: function(chartConfig) {
            ...
            if (Array.isArray(this.options.yAxis)) {
                ...
                chartConfig.vertical_axis_crosshair == 1 ? this.options.yAxis[0].crosshair = !0 : this.options.yAxis[0].crosshair = !1;
                chartConfig.horizontal_axis_label ? this.options.yAxis[0].title = {
                    text: chartConfig.vertical_axis_label
                } : null;
                ...
                chartConfig.vertical_axis_crosshair == 1 ? this.options.yAxis.crosshair = !0 : this.options.yAxis.crosshair = !1;
                chartConfig.horizontal_axis_label ? this.options.yAxis.title = {
                    text: chartConfig.vertical_axis_label
                } : null;
            ...
            chartConfig.vertical_axis_label ? this.options.xAxis.title = {
                text: chartConfig.horizontal_axis_label
            } : null;
            chartConfig.horizontal_axis_crosshair == 1 ? this.options.xAxis.crosshair = !0 : this.options.xAxis.crosshair = !1;
            chartConfig.inverted == 1 ? this.options.chart.inverted = !0 : this.options.chart.inverted = !1;
            chartConfig.show_title == 1 ? this.options.title.text = chartConfig.chart_title : this.options.title.text = '';
            chartConfig.title_floating == 1 ? this.options.title.floating = !0 : this.options.title.floating = !1;
            ...
            chartConfig.tooltip_enabled == 1 ? this.options.tooltip.enabled = !0 : this.options.tooltip.enabled = !1;
            ...
            chartConfig.tooltip_shared == 1 ? this.options.tooltip.shared = !0 : this.options.tooltip.shared = !1;
            ...
            if (!(chartConfig.chart_type == 'highcharts_treemap_level_chart')) {
                chartConfig.show_legend == 1 ? this.options.legend.enabled = !0 : this.options.legend.enabled = !1;
            ...
            chartConfig.exporting == 1 ? this.options.exporting.enabled = !0 : this.options.exporting.enabled = !1;
            chartConfig.exporting_data_labels == 1 ? this.options.exporting.chartOptions.plotOptions.series.dataLabels.enabled = !0 : this.options.exporting.chartOptions.plotOptions.series.dataLabels.enabled = !1;
            ...
            chartConfig.credits == 1 ? this.options.credits.enabled = !0 : this.options.credits.enabled = !1;
                                ...
                                if (obj.options.chart.type == 'pie') {
                                    if (obj.numberFormat == 1) {
                                        seriesDataEntry.push({
                                            ...
                                            y: parseFloat(wdtUnformatNumber(entry, '.', ',', !0))
                                        })
                                    } else {
                                        seriesDataEntry.push({
                                            name: obj.options.xAxis.categories[i],
                                    ...
                                    if (obj.numberFormat == 1) {
                                        seriesDataEntry.push({
                                            colorValue: parseFloat(wdtUnformatNumber(entry, '.', ',', !0)),
                                            name: obj.options.xAxis.categories[i],
                                            value: parseFloat(wdtUnformatNumber(entry, '.', ',', !0))
                                        })
                                    } else {
                                        seriesDataEntry.push({
                                            colorValue: parseFloat(wdtUnformatNumber(entry, ',', '.', !0)),
